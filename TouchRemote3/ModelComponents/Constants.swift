...
let red1 = UIColor(red: 0.9, green: 0.2, blue: 0.3, alpha: 1.0)
let yellow1 = UIColor(red: 0.9, green: 0.8, blue: 0.05, alpha: 1.0)
let mint1 = UIColor(red: 0.15, green: 0.7, blue: 0.5, alpha: 1.0)
let purple1 = UIColor(red: 0.55, green: 0.25, blue: 0.8, alpha: 1.0)
...
let orange2 = UIColor(red: 0.9, green: 0.5, blue: 0.25, alpha: 1.0)
